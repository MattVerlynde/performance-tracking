...
def eval_model(args, storage_path):
    with tf.Session(config=config) as sess:
        ...
        summary_writer = tf.summary.FileWriter(os.path.join(storage_path, 'logs', 'test'), sess.graph)
        ...
        with open(os.path.join(storage_path, 'eval_result.json'), 'wb') as f:
...
if __name__ == "__main__":
    ...
    eval_model(args, parser_args.storage_path)
