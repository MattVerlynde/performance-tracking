...
def plot_stats(storage_path, output_path):
    ...
    data_legend['Parameters'] = "Window size: " + data["Window size"].astype(str) + ", Threads: " + data["Threads"].astype(str) + ", Method: " + data["Method"].astype(str) + ", Number of images: " + data["Number images"].astype(str) 
